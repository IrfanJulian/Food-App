          ...
          <div className="container mx-auto hidden md:flex py-3">
              ...
              { token ?
                  <div className="w-full flex">
                    <div className='flex w-11/12 space-x-20'>
                      <button onClick={()=>router.push('/')} className='h-max mt-2 font-semibold transition-all duration-300 text-xl text-white hover:scale-110 py-2 px-5 rounded-full hover:bg-gray-500 hover:opacity-80'>Home</button>
                      <button onClick={()=>router.push(`/menu/add-menu`)} className='h-max mt-2 font-semibold transition-all duration-300 text-xl text-white hover:scale-110 py-2 px-5 rounded-full hover:bg-gray-500 hover:opacity-80'>Add Recipe</button>
                      <button onClick={()=>router.push(`/profile/${id}`)} className='h-max mt-2 font-semibold transition-all duration-300 text-xl text-white hover:scale-110 py-2 px-5 rounded-full hover:bg-gray-500 hover:opacity-80'>Profile</button>
                    </div>
                    <div className='w-1/12 h-max grid'>  
                      <button onClick={()=>{localStorage.clear(); router.push(`/auth/login`)}} className='flex h-max mt-2 ml-auto font-semibold transition-all duration-300 text-xl text-white hover:scale-110 py-2 px-5 rounded-full hover:bg-gray-500 hover:opacity-80'>
              ...
              :
                <div className="w-1/12 ml-auto grid">
                  <button onClick={()=>router.push('/auth/login')} className='flex h-max mt-2 ml-auto font-semibold transition-all duration-300 text-xl text-white hover:scale-110 py-2 px-5 rounded-full hover:bg-gray-500 hover:opacity-80'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 mr-2 text-white">
